...
특정 과목의 고정 단원 사전에 의존하지 않고, 입력된 문항 데이터에서 자주 등장하는 키워드를 기반으로 자동 주제 그룹을 생성합니다.  
따라서 정보처리기사, 한국사, 국어, 전기기사 등 임의의 시험에 범용적으로 적용할 수 있습니다.
...
- **연도별 출제 경향**: 연도별 문항 수 집계
- **난이도 분석**: 난이도 분포 및 연도별 평균 난이도 산출
